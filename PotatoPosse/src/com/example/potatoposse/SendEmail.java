    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newAddress.setOnClickListener( new OnClickListener(){
        	public void onClick(View view){
                ...
                final AlertDialog ad = new AlertDialog.Builder(SendEmail.this).create();
        		ad.setTitle("New Email Address");
        		ad.setMessage("Please enter email address:");
        		
        		final EditText input = new EditText(SendEmail.this);
        		ad.setView(input);
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(mat.matches()){
							...
							ad.dismiss();
							 ...
							 Toast.makeText(SendEmail.this, "Please enter a valid email address!", Toast.LENGTH_SHORT).show();
